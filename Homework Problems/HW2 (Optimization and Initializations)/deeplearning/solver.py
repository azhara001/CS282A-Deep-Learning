...
class Solver(object):
    ...
    def __init__(self, model, data, **kwargs):
        ...
        self.update_rule = kwargs.pop('update_rule', 'sgd') # update rule is the key being looked for in the dictionary kwargs and sgd is a default value provided in case update rule is not found in kwargs 
        ...
        self.update_rule = getattr(optim, self.update_rule) # self.update rule is now a function that is being imported from the file optim (from str, we checked if we have the optimizer corressponding to that str and then set that function in the self.update_rule variable)
    ...
    def _step(self):
        ...
        #############################################################################
        self.log_grad_norm_history.append(sum(norms)/len(norms))
        #############################################################################
        #                             END OF YOUR CODE                              #
        #############################################################################
